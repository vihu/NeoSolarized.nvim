...
function M.setup()
  ...
  theme.highlights = {
    ...
    NormalNC                             = options.dim_inactive and {fg = c.fg0, bg = options.transparent and c.bg1} or {link = "Normal" },                  -- normal text in non-current windows
    ...
    -- Barbar
    BufferCurrent                       = { bg = c.bg1, fg = c.base2 },
    BufferCurrentIndex                  = { bg = c.bg1, fg = c.base2 },
    BufferCurrentMod                    = { bg = c.bg1, fg = c.red },
    BufferCurrentSign                   = { bg = c.bg1, fg = c.blue },
    BufferCurrentTarget                 = { bg = c.bg1, fg = c.red },
    ...
    BufferInactive                        = { bg = c.fg2, fg = c.fg0 },
    BufferInactiveIndex                   = { bg = c.fg2, fg = c.base2 },
    BufferInactiveMod                     = { bg = c.fg2, fg = c.yellow },
    BufferInactiveSign                    = { bg = c.fg2, fg = c.yellow },
    BufferInactiveTarget                  = { bg = c.fg2, fg = c.red },
